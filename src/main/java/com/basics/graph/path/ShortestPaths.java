...
//You would like to compute an optimal way of exchanging the given currency 𝑐 𝑖 into all other currencies.
// For this, you find shortest paths from the vertex 𝑐 𝑖 to all the other vertices.
public class ShortestPaths {

    //Given an directed graph with possibly negative edge weights
    // and with 𝑛 vertices and 𝑚 edges as well as its vertex 𝑠,
