//package com.basics.graph.spanningTrees;
...
import java.util.Scanner;
     ...
     * To ensure K clusters, note that MST of N nodes must have N-1 edges.
     *     Consider meta-graph G' of K clusters as K vertices;
     *     G' is still MST with K-1 edges.
     *     find the top K-1 largest edges and the smallest will be d.
     * Example: 12  7 6 4 3 5 1 1 7 2 7 5 7 3 3 7 8 2 8 4 4 6 7 2 6  3 -> 2.828427124746
     * Example: 8  3 1  1 2 4 6 9 8 9 9 8 9 3 11 4 12 ->  4
    ...
    public class Clustering {
        ...
        private static double clustering(int[] x, int[] y, int k) {
            ...
            // initial capacity, instead of fixed capacity.
